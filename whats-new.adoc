...
[role="lead"]
BlueXP（Cloud Manager）のKubernetesの新機能をご紹介します。
...
* link:https://docs.netapp.com/us-en/cloud-manager-kubernetes/task/task-kubernetes-discover-openshift.html["OpenShiftクラスタをCloud Managerにインポートします"]
